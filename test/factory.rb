...
module Factory
  ...
  def self.build(model, &block)
    ...
    puts "### modelmodelmodel  ###>>  #{model.inspect}"
  ...
  build Employee do |attributes|
    attributes.reverse_merge!(name: 'John Smith')
  end
  ...
  build Preference do |attributes|
    ...
    attributes.reverse_merge!(name: 'notifications', value: false)
  end

  build User do |attributes|
    attributes.reverse_merge!(login: 'admin')
  end
end
